...
Carteiras: XP Top Dividendos Plus | BTG Dividendos | Itaú BBA Dividendos
...
OUT_PATH = os.path.join(PASTA, "comparacao_carteiras.xlsx")
...
CARTEIRAS = {
    "XP Dividendos": {
        # XP Top Dividendos Plus — junho 2026
    ...
    "BTG Dividendos": {
        # BTG Pactual Carteira Dividendos — junho 2026
...
disc_full = [
    ...
    ("AXIA6 (PN Axia Energia, ex-ELET6) substituído por AXIA3 (ON) por ausência de histórico no snapshot. As duas classes são altamente correlacionadas mas não idênticas. ROXO34 (BDR Nubank) excluído do portfólio XP por ausência de dados; os pesos foram renormalizados.", False, C_WHITE),
    ("", False, C_WHITE),
