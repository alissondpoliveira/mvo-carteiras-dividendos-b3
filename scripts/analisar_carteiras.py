...
disc_full = [
    ...
    ("Esta planilha é de natureza exclusivamente educacional e demonstrativa. Não constitui recomendação, oferta ou solicitação de compra ou venda de valores mobiliários. O objetivo é ilustrar conceitos de otimização de portfólio (máximo Sharpe/Mean-Variance) e análise de risco quantitativo.", False, C_WHITE),
    ("", False, C_WHITE),
